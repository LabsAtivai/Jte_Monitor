    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          {modo === "register" && (
            <Campo label="Nome" type="text" value={nome}
          ...
          {modo === "login" ? (
            <>
              ...
              <span
                ...
                style={{ color: "#1a56a4", cursor: "pointer", fontWeight: 500 }}
              >
                Cadastre-se grátis
              </span>
            </>
        ...
        {modo === "register" && (
          <div style={{
            ...
            Conta gratuita: acesso completo. Upgrade para Premium desbloqueia alertas por e-mail.
          </div>
        )}
      </div>
    </div>
